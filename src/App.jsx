...
const COLLEGES = [
  ...
  { id: "harvard", name: "Harvard University", country: "USA", region: "Ivy League", acceptanceRate: "3.4%", competitiveness: "Extreme",
    ...
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/c/cc/Harvard_University_by_Dav.d.jpg/800px-Harvard_University_by_Dav.d.jpg",
  ...
  { id: "yale", name: "Yale University", country: "USA", region: "Ivy League", acceptanceRate: "4.5%", competitiveness: "Extreme",
    ...
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/07/Yale_University_Old_Campus_1.jpg/800px-Yale_University_Old_Campus_1.jpg",
  ...
  { id: "princeton", name: "Princeton University", country: "USA", region: "Ivy League", acceptanceRate: "4.0%", competitiveness: "Extreme",
    ...
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/56/Nassau_Hall%2C_Princeton_University.jpg/800px-Nassau_Hall%2C_Princeton_University.jpg",
  ...
  { id: "columbia", name: "Columbia University", country: "USA", region: "Ivy League", acceptanceRate: "3.9%", competitiveness: "Extreme",
    ...
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/9d/Butler_Library%2C_Columbia_University.jpg/800px-Butler_Library%2C_Columbia_University.jpg",
  ...
  { id: "penn", name: "University of Pennsylvania", country: "USA", region: "Ivy League", acceptanceRate: "5.4%", competitiveness: "Extreme",
    ...
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/92/UPenn_campus_from_Locust_Walk.jpg/800px-UPenn_campus_from_Locust_Walk.jpg",
  ...
  { id: "brown", name: "Brown University", country: "USA", region: "Ivy League", acceptanceRate: "5.6%", competitiveness: "Extreme",
    ...
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f1/2016_Brown_University_Commencement_-_panoramio.jpg/800px-2016_Brown_University_Commencement_-_panoramio.jpg",
  ...
  { id: "dartmouth", name: "Dartmouth College", country: "USA", region: "Ivy League", acceptanceRate: "6.0%", competitiveness: "Extreme",
    ...
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a3/Dartmouth_College_campus_2013.jpg/800px-Dartmouth_College_campus_2013.jpg",
  ...
  { id: "cornell", name: "Cornell University", country: "USA", region: "Ivy League", acceptanceRate: "8.4%", competitiveness: "Very High",
    ...
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/7/77/Ezra_Cornell_statue_overlooking_Cayuga_Lake.jpg/800px-Ezra_Cornell_statue_overlooking_Cayuga_Lake.jpg",
  ...
  { id: "mit", name: "MIT", country: "USA", region: "Top US (STEM)", acceptanceRate: "4.6%", competitiveness: "Extreme",
    ...
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0c/MIT_campus_from_Mass_Ave_bridge.jpg/800px-MIT_campus_from_Mass_Ave_bridge.jpg",
  ...
  { id: "stanford", name: "Stanford University", country: "USA", region: "Top US (STEM)", acceptanceRate: "3.9%", competitiveness: "Extreme",
    ...
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4e/Stanford_main_quad_and_hoover_tower.jpg/800px-Stanford_main_quad_and_hoover_tower.jpg",
  ...
  { id: "caltech", name: "California Institute of Technology", country: "USA", region: "Top US (STEM)", acceptanceRate: "3.9%", competitiveness: "Extreme",
    ...
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a4/Caltech_campus_-_Millikan_Library.jpg/800px-Caltech_campus_-_Millikan_Library.jpg",
  ...
  { id: "johns_hopkins", name: "Johns Hopkins University", country: "USA", region: "Top US (STEM)", acceptanceRate: "7.0%", competitiveness: "Very High",
    ...
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8e/Homewood_campus_of_Johns_Hopkins_University.jpg/800px-Homewood_campus_of_Johns_Hopkins_University.jpg",
  ...
  { id: "oxford", name: "University of Oxford", country: "UK", region: "UK (Oxbridge)", acceptanceRate: "~13%", competitiveness: "Very High",
    ...
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/ff/Oxford_Radcliffe_Camera_crop.jpg/800px-Oxford_Radcliffe_Camera_crop.jpg",
    virtualTour: "https://www.ox.ac.uk/admissions/undergraduate/visits/virtual-tour" },
  { id: "cambridge", name: "University of Cambridge", country: "UK", region: "UK (Oxbridge)", acceptanceRate: "~21%", competitiveness: "Very High",
    ...
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/89/Kings_College_Cambridge_-_Front.jpg/800px-Kings_College_Cambridge_-_Front.jpg",
    virtualTour: "https://www.undergraduate.study.cam.ac.uk/find-out-more/virtual-cambridge" },
  { id: "imperial", name: "Imperial College London", country: "UK", region: "UK (Top STEM)", acceptanceRate: "~14%", competitiveness: "High",
    ...
    image: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/60/Imperial_College_London_Main_Entrance.jpg/800px-Imperial_College_London_Main_Entrance.jpg",
    virtualTour: "https://www.imperial.ac.uk/study/visit/virtual-tours/" },
  // Nigeria Federal
  { id: "unilag", name: "University of Lagos (UNILAG)", country: "Nigeria", region: "Nigeria (Top Federal)", acceptanceRate: "Competitive (Post-UTME based)", competitiveness: "High",
    ...
    virtualTour: "https://unilag.edu.ng/campus-2/" },
    ...
    <div style={S.screen}>
      <div style={{ position: "relative", height: 200 }}>
        ...
        <div style={{ position: "absolute", bottom: 16, left: 20, right: 20 }}>
          ...
          <div style={{ fontSize: 13, color: "#CBD5E1", marginTop: 4 }}>{college.country}</div>
        </div>
      </div>
          ...
          {filtered.map(c => {
            ...
            return (
              <button key={c.id} onClick={() => setSelected(c)} style={{ ...S.cardAlt, display: "flex", gap: 12, cursor: "pointer", textAlign: "left", padding: 12, alignItems: "center" }}>
                <img src={c.image} alt={c.name} style={{ width: 56, height: 56, borderRadius: 12, objectFit: "cover", flexShrink: 0 }} />
...
function SplashScreen() {
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", height: "100vh", backgroundColor: "#080D1E" }}>
      <div style={{ width: 72, height: 72, borderRadius: 20, background: "linear-gradient(135deg, #3B82F6 0%, #1E3A5F 100%)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 32, marginBottom: 18, boxShadow: "0 8px 28px rgba(59,130,246,0.3)" }}>
        🎯
      </div>
