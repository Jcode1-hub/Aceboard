...
const COLLEGES = [
  ...
  { id: "princeton", name: "Princeton University", country: "USA", region: "Ivy League", acceptanceRate: "4.0%", competitiveness: "Extreme",
    ...
    image: "https://images.unsplash.com/photo-1591123967199-ab319ed94a93?w=800&q=80" },
  { id: "mit", name: "MIT", country: "USA", region: "Top US (STEM)", acceptanceRate: "4.0%", competitiveness: "Extreme",
    requirements: ["SAT Math 780+ recommended", "Calculus + Physics coursework", "2 SAT subject-style tests (Math + Science)", "Portfolio for some programs", "Strong problem-solving essays"],
  ...
  { id: "stanford", name: "Stanford University", country: "USA", region: "Top US (STEM)", acceptanceRate: "3.9%", competitiveness: "Extreme",
    ...
    image: "https://images.unsplash.com/photo-1602052793312-b9d7e54a3c33?w=800&q=80" },
  // UK
  ...
  { id: "cambridge", name: "University of Cambridge", country: "UK", region: "UK (Oxbridge)", acceptanceRate: "~21%", competitiveness: "Very High",
    ...
    image: "https://images.unsplash.com/photo-1500313830540-7b6650a74fd0?w=800&q=80" },
  ...
  { id: "unilag", name: "University of Lagos (UNILAG)", country: "Nigeria", region: "Nigeria (Top Federal)", acceptanceRate: "Competitive (Post-UTME based)", competitiveness: "High",
    ...
    notes: "Medicine, Law, and Engineering are the most competitive. Post-UTME cutoff varies yearly by department.",
  ...
  { id: "oau", name: "Obafemi Awolowo University (OAU)", country: "Nigeria", region: "Nigeria (Top Federal)", acceptanceRate: "Competitive (Post-UTME based)", competitiveness: "High",
    ...
    notes: "Known for strong Pharmacy, Medicine, and Engineering programs. Very competitive cutoffs each year.",
    image: "https://images.unsplash.com/photo-1591123967199-ab319ed94a93?w=800&q=80" },
  { id: "ui", name: "University of Ibadan (UI)", country: "Nigeria", region: "Nigeria (Top Federal)", acceptanceRate: "Competitive (Post-UTME based)", competitiveness: "High",
    ...
    notes: "Nigeria's first university. Strong reputation across Medicine, Law, and Arts.",
    image: "https://images.unsplash.com/photo-1523050854058-8df90110c9f1?w=800&q=80" },
  { id: "covenant", name: "Covenant University", country: "Nigeria", region: "Nigeria (Top Private)", acceptanceRate: "Moderate-High", competitiveness: "Moderate",
    ...
    notes: "Private university known for Business, Engineering, and strong career placement support.",
    image: "https://images.unsplash.com/photo-1564981797816-1043664bf78d?w=800&q=80" },
];
...
function generateHeatmapData(weeksBack = 26) {
  ...
  const cells = [];
  // seeded pseudo-random so it looks consistent across renders
  let seed = 42;
  const rand = () => {
...
function SignInScreen({ onSignedIn }) {
  ...
  <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", minHeight: "100vh", padding: "0 28px", backgroundColor: "#080D1E" }}>
    <div style={{ textAlign: "center", marginBottom: 40 }}>
      <div style={{ width: 72, height: 72, borderRadius: 20, margin: "0 auto 16px", overflow: "hidden" }}>
        <img src="/icon.png" style={{ width: 72, height: 72 }} alt="AceBoard" />
      </div>
      <div style={{ fontSize: 28, fontWeight: 800, color: "#fff" }}>Ace<span style={{ color: "#3B82F6" }}>Board</span></div>
      <p style={{ color: "#94A3B8", fontSize: 14, marginTop: 8 }}>Sign in to save your progress, streaks, and bookmarks across sessions.</p>
    </div>
    <button
      onClick={handleGoogleSignIn}
      disabled={loading}
      style={{ width: "100%", padding: "15px 20px", backgroundColor: "#fff", color: "#1F2937", borderRadius: 12, border: "none", fontSize: 16, fontWeight: 600, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 10 }}>
      <span style={{ fontSize: 18 }}>G</span> Continue with Google
    </button>
    {error && <p style={{ color: "#EF4444", textAlign: "center", marginTop: 16, fontSize: 14 }}>{error}</p>}
    <p style={{ color: "#475569", fontSize: 12, textAlign: "center", marginTop: 24 }}>By continuing, your name and email are used to personalize your AceBoard account.</p>
  </div>
);
}
// ── SPLASH SCREEN ─────────────────────────────────────────────────────────────
